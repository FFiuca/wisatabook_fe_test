...
export const changeStarredTask = ()=>{
  ...
  const doChangeStarred = async (id, param)=>{
    let resp

      toggleLoading()
      resp = await axios.patch(url+id+'/change_starred_status/', param, {
        headers: {
  ...
  return  {data, loading, error, doChangeStarred}
}
