                              ...
                              return (
                                <CListGroupItem key={`og-${idx}`}>
                                  <div className="d-flex">
                                    <CFormCheck style={{ cursor:'pointer' }} className="text-strong" label={el.title}  onClick={()=> handleModalUpdate(el.id)} />
                                    <CButton
                                      size="sm"
                                      color="danger"
                                      variant="ghost"
                                  ...
                                  <div className="ps-4 d-flex gap-2 flex-wrap">
                                    ...
                                    <div className="ms-auto">
                                      <svg style={{ cursor:'pointer' }} width="20" height="20" viewBox="0 0 24 24" fill={el.starred_status? 'yellow': 'none'} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <CListGroup>
                          {
                            Array.isArray(dataComplete) && dataComplete.length>0 && dataComplete.map((el, idx)=>{
                              return (
                                <CListGroupItem key={`cp-${idx}`} onClick={()=> handleModalUpdate(el.id)}>
                                  <CFormCheck className="text-strong" label={el.title} />
                                  <div className="ps-4 d-flex gap-2 flex-wrap">
                                  ...
                                  <p className="ps-4">{el.description}</p>
                                </CListGroupItem>
                              )
                            })
                          }
